...
namespace ConsoleExcelTest01
{
    ...
    {
        private void SameCell(ISheet sheet)
        {
         ...
         */
        private void MultiCell(ISheet sheet)
        {
            // header row
         ...
         */
        private void Errors(ISheet sheet)
        {
            sheet.CreateRow(0).CreateCell(0).SetCellValue(84);
         ...
         */
        private void HideDupplicates(ISheet sheet)
        {
         ...
         */
        private void FormatDuplicates(ISheet sheet)
        {
         ...
         */
        private void InList(ISheet sheet)
        {
         ...
         */
        private void Expiry(ISheet sheet)
        {
         ...
         */
        private void ShadeAlt(ISheet sheet)
        {
            ISheetConditionalFormatting sheetCF = sheet.SheetConditionalFormatting;
         ...
         */
        private void ShadeBands(ISheet sheet)
        {
            ISheetConditionalFormatting sheetCF = sheet.SheetConditionalFormatting;
        ...
        public void Run()
        {
            ...
            using (var fs = File.Create(@"C:\00.Dev\temp\ConditionalFormats.xlsx"))
            {
                wb.Write(fs);
            }
        }
